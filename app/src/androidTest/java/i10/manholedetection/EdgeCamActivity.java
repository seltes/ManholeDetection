...
public class EdgeCamActivity extends Activity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        detectManhole=new DetectManhole(inputFrame.gray(),inputFrame.rgba(),0);
